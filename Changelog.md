...
- **Breaking change for custom CSS:** Classes have been prefixed to avoid conflicts with common class names. Example: `.title` → `.lil-title`. ([Read more](https://github.com/georgealways/lil-gui/pull/154))
